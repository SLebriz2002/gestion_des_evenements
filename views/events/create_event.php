...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $message = "<p class='success-message'>Événement ajouté avec succès !</p>";
    } catch (Exception $e) {
...
<div style="text-align: center; margin-top: 30px;">
    <a href="http://localhost/gestion_evenements/views/" style="
...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <label for="date_evenement">Date (AAAA-MM-JJ) :</label>
